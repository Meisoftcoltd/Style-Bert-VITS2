...
def extract_bert_feature(
    ...
    elif language == Languages.ES:
        from style_bert_vits2.nlp.spanish.bert_feature import extract_bert_feature
    else:
...
def extract_bert_feature_onnx(
    ...
    if language == Languages.JP:
        ...
        from style_bert_vits2.nlp.spanish.bert_feature import extract_bert_feature_onnx
    else:
        raise ValueError(f"Language {language} not supported")
...
def clean_text(
    ...
    if language == Languages.JP:
        ...
        from style_bert_vits2.nlp.spanish.g2p import g2p
